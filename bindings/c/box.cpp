...
ManifoldScalar manifold_box_scale(ManifoldBox* b) { return from_c(b)->Scale(); }

int manifold_box_contains_pt(ManifoldBox* b, ManifoldScalar x, ManifoldScalar y,
                              ManifoldScalar z) {
  auto p = vec3(x, y, z);
...
void manifold_box_include_pt(ManifoldBox* b, ManifoldScalar x, ManifoldScalar y,
                              ManifoldScalar z) {
  auto& box = *from_c(b);
  auto p = vec3(x, y, z);
  box.Union(p);
